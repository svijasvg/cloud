...
def get_single_svg(parent_obj, screen_code, page_width, use_p3, is_page, object_name):
...
# raw_name = raw_name.replace("'", "\\/'")
  ...
  svg_id, svg_width, svg_height, svg = rewrite_svg(raw_name, svg_path, settings_id, use_p3, is_page, object_name)
